...
((w, undefined_) ->
  ...
  enabledClassName = "scroll-enabled"
...
((w, o, undefined_) ->
  ...
  o.closest = (target, ascend) ->
    not ascend and target.className and target.className.indexOf(scrollIndicatorClassName) > -1 and target or o.closest(target.parentNode)
